...
- [x] 03-03: useChat integration with streaming
- [x] 03-04: Error handling + French messages + TNS fallback (chat-errors.ts, ChatErrorBanner, fallback CTA, hardened API route)
